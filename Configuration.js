...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var hearbeattime = endpoints.addEndpoint("2", "Hearbeattime", endpointType.genericSensor);
    hearbeattime.variableTypeId = 1279;
    endpoints.addEndpoint("3", "Warning Status", endpointType.iasSensor, iasEndpointSubType.alarmInput);
